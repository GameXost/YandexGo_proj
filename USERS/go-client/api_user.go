...
func (r ApiGetUserProfileRequest) Execute() (*ClientServiceUser, *http.Response, error) {
...
func (r ApiUpdateUserProfileRequest) Execute() (*ClientServiceUser, *http.Response, error) {
