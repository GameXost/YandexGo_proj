	...
	return []Route{ 
		{
			...
			http.MethodGet,
			"/driver/:id",
			handleFunctions.DriverAPI.GetDriverInfo,
		},
		{
			"GetDriverLocation",
			http.MethodGet,
			"/driver/:id/location",
			handleFunctions.LocationAPI.GetDriverLocation,
		},
		{
			"CancelRide",
			http.MethodPost,
		...
		},
		{
			...
			http.MethodGet,
			"/ride/history",
			handleFunctions.RidesAPI.GetRidesHistory,
		},
		{
			"RequestRide",
			http.MethodPost,
			"/ride/request",
			handleFunctions.RidesAPI.RequestRide,
		},
		{
			"GetUserProfile",
			http.MethodGet,
			"/user/profile",
			handleFunctions.UserAPI.GetUserProfile,
		},
		{
			"UpdateUserProfile",
			http.MethodPut,
			"/user/profile",
			handleFunctions.UserAPI.UpdateUserProfile,
		},
	}
}
