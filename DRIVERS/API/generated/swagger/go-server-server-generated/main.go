...
import (
	...
	sw "github.com/GameXost/YandexGo_proj/DRIVERS/API/generated/swagger/go-server-server-generated/go"
...
func convertDrivertoPB(d *models.Driver) *pb.Driver {
	return &pb.Driver{
		Id:        d.ID,
		Username:  d.UserName,
		Email:     d.Email,
...
func (s *DriverServer) UpdateDriverProfile(ctx context.Context, req *pb.UpdateDriverProfileRequest) (*pb.Driver, error) {
	...
	err = s.db.QueryRow(ctx, query,
		...
		updated.CarMark,
		updated.CarColor,
		driverID).Scan(&driverID, &driver.UserName, &driver.Email, &driver.Phone, &driver.Car_number, &driver.Car_model, &driver.Car_marks, &driver.Car_color)
	if err != nil {
